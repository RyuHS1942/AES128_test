...
BYTE p[] = { 
	0x0f, 0x15, 0x71, 0xc9, 0x47, 0xd9, 0xe8, 0x59, 0x0c, 0xb7, 0xad, 0x67, 0xaf, 0x7f, 0x67, 0x98
};
...
void printResult(const char* keyword, uint8_t* data) {
	int i = 0;
	printf(" - %s : ", keyword);
	for (i = 0; i < 64; i++) {
		if (i % 16 == 0) printf("\n");
...
int main() {
	...
	for (i = 0; i < 4; i++) {
		...
		AES128(result + i * 16, tmpBlock, p, ENC);
